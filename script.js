document.addEventListener('DOMContentLoaded', function () {
  ...
  function applyInitialStyles(el) {
    if (!el.classList.contains('fade-in') &&
        ...
        !el.hasAttribute('data-animate')) return;
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "PAZ (פז) משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: 'ee71fb66-92a3-4c83-a569-675ec8107036',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || 'ee71fb66-92a3-4c83-a569-675ec8107036';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'ee71fb66-92a3-4c83-a569-675ec8107036';
